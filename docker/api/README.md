...
Esta flag aumenta a imagem em alguns MB em troca de um startup mais rápido, uma escolha que só faz sentido à luz do dimensionamento definido em [`sizing/`](../sizing/README.md#escalabilidade-automática).
