...
Um detalhe que pesou na escolha: o Application Insights **não tem cobrança própria**. A telemetria é faturada pela ingestão do mesmo Log Analytics Workspace já utilizado para os logs, o que evita um segundo medidor de custo.
